...
public class ManualInputInterfaces {
    ...
    // elevator movement config
    private ElevatorPositions targetElevatorPosition = null;
            ...
            if (this.subsystemCollection.isElevatorSubsystemAvailable()) {
                ...
                this.coDriverController.y().onTrue(
                        new ParallelCommandGroup(
                                new InstantCommand(
                                        () -> {
                                            if (this.targetElevatorPosition != null) {
                                                new MoveToPositionCommand(
                                                        this.subsystemCollection.getElevatorSubsystem(),
                                                        this.targetElevatorPosition).schedule();
                                            } else {
                                                DataLogManager.log("TARGET ELEVATOR POSITION IS NULL");
                                            }
                                        }),
                                new ButtonPressCommand(
                ...
                this.coDriverController.povLeft().onTrue(
                        new ParallelCommandGroup(
                                new InstantCommand(() -> this.targetElevatorPosition = ElevatorPositions.L1),
                                new ButtonPressCommand(
                ...
                this.coDriverController.povDown().onTrue(
                        new ParallelCommandGroup(
                                new InstantCommand(() -> this.targetElevatorPosition = ElevatorPositions.L2),
                                new ButtonPressCommand(
                ...
                this.coDriverController.povRight().onTrue(
                        new ParallelCommandGroup(
                                new InstantCommand(() -> this.targetElevatorPosition = ElevatorPositions.L3),
                                new ButtonPressCommand(
                ...
                this.coDriverController.povUp().onTrue(
                        new ParallelCommandGroup(
                                new InstantCommand(() -> this.targetElevatorPosition = ElevatorPositions.L4),
                                new ButtonPressCommand(
