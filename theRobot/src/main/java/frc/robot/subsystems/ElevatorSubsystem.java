...
public class ElevatorSubsystem extends SubsystemBase {
  ...
  private void configureMotor() {
    ...
    motorTalonMotorConfiguration.CurrentLimits.StatorCurrentLimit = Constants.elevatorMotorStatorCurrentMaximumAmps;
    motorTalonMotorConfiguration.CurrentLimits.StatorCurrentLimitEnable = true;
    motorTalonMotorConfiguration.CurrentLimits.SupplyCurrentLimit = Constants.elevatorMotorSupplyCurrentMaximumAmps;
