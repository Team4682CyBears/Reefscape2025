...
public interface ICorrectableEncoder {
    ...
    /**
     * An interface method that will be used to both correct (when necessary) the
     * motors encoder
    ...
    /**
     * An interface method that needs to be call in periodic to correct the sensor
    ...
    /**
     * An interface method that will be used to determine if the motor encoder
     * position has ever been reset.
     * 
